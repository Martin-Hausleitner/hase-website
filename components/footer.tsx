  ...
  return (
    <footer className="bg-background text-foreground border-t py-12">
      <div className="container px-4 md:px-6">
        ...
        <div className="flex flex-col md:flex-row md:items-start md:justify-between">
          ...
          <div className="mb-8 md:mb-0 md:mr-8">
            ...
            <div className="space-y-2">
              <a href="mailto:office@flirtagent.ai" 
                className="block text-sm text-muted-foreground hover:text-foreground transition-colors">
                office@flirtagent.ai
              </a>
              <p className="text-sm text-muted-foreground">
                Automated AI agents for content creators
              </p>
            </div>
          </div>

          {/* Center - Links organized in columns */}
          ...
          <div className="mt-8 md:mt-0">
            ...
            <div className="flex space-x-4">
              ...
              <a 
                href="https://instagram.com/flirtagent" 
                target="_blank" 
              ...
              <a 
                href="https://twitter.com/flirtagent" 
                target="_blank" 
                rel="noopener noreferrer" 
                className="flex items-center justify-center w-10 h-10 rounded-full bg-muted hover:bg-muted/80 transition-colors"
              ...
              <a 
                href="https://linkedin.com/company/flirtagent" 
                target="_blank" 
                rel="noopener noreferrer" 
                className="flex items-center justify-center w-10 h-10 rounded-full bg-muted hover:bg-muted/80 transition-colors"
                aria-label="LinkedIn"
        ...
        <div className="mt-12 pt-6 border-t flex flex-col md:flex-row md:justify-between md:items-center">
